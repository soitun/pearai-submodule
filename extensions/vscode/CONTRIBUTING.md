...
2. Open the Continue React app in a side panel. The React app's source code lives in the `gui` directory. The panel is opened by the `pearai.openContinueGUI` command, as defined in `src/commands.ts`.
