...
export class CompletionProvider {
  ...
  async getTabCompletion(
    ...
    if (
      ...
      throw new Error(
        `Warning: ${llm.model} is not trained for tab-autocomplete, and will result in low-quality suggestions. See the docs to learn more about why: https://docs.pearai.dev/features/tab-autocomplete#i-want-better-completions-should-i-use-gpt-4`,
      );
    }
